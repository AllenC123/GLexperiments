...
// This version of main creates the ImGui window, and launches the torus window in another thread
...
/* #include <GL/glut.h>
glutInit();
glutSolidTorus(0.5f, 1.0f, 16, 16); */
...
int main(int argc, char** argv, char** envp)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to create a named window.
        {
            ...
            if (ImGui::Button("Vsync Toggle"))
            {
                if (isVsync) glfwSwapInterval(0);
                else glfwSwapInterval(1);

                isVsync = !isVsync;
            }
            ImGui::SameLine();
            ImGui::Text("Vsync: %s", (isVsync? "enabled" : "disabled"));
    ...
    //if ((testThread.joinable()) && (!ShouldStopRendering))
    if (testThread.joinable()) // we shouldn't need to check 'ShouldStopRendering'?
    {
